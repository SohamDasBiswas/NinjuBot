...
MY_GUILD_ID = 1342866797958926368
...
async def start_bot():
    ...
    while True:
        # Create fresh bot instance every attempt
        bot = make_bot()
        ...
        async def on_ready():
            ...
            await send_status("✅ NinjuBot is Online!", f"Bot started.\n**Servers:** {len(bot.guilds)}", 0x2ECC71)
